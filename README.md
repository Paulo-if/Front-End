...
1.  **📍 Introdução** — Base conceitual e mentalidade dev.
2.  **🌐 Web e HTML** — A estrutura de tudo.
3.  **🎨 CSS** — "A arte de deixar bonito".
4.  **🖌️ Figma + UI/UX** — Design focado no Front-End.
5.  **⚡ JavaScript (JS)** — A alma da web.
6.  **🔌 APIs** — O básico necessário para comunicação.
7.  **🤝 Git + GitHub** — Comunicação e colaboração profissional.
8.  **⚛️ React** — O ecossistema de bibliotecas modernas.
9.  **📱 Responsividade** — Dispositivos de todos os tamanhos.
10. **✨ #extra** — Conteúdo bônus e avançado.
...
O site foi construído utilizando as melhores ferramentas atuais:
